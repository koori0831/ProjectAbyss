...
public class ItemInspector : IDisposable
{
    ...
    private Button _nameChangheBtn;
    ...
    public ItemInspector(VisualElement content, PoolEditorWindow editorWnd)
    {
        ...
        _nameChangheBtn = content.Q<Button>("BtnChange");
        ...
        _nameChangheBtn.clicked += HandleNameChange;
    }
    ...
    private void HandleNameChange()
    {
        ...
        if(EditorUtility.DisplayDialog("Reneme", $"Rename this asset to {newName}", "Yes", "No"))
        {
